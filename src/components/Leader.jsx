                            ...
                            <Card className={classes.root} elevation={0}>
                                ...
                                <CardContent>
                                    ...
                                    <Typography variant="body2" color="textSecondary" component="p" align="left" style={{ marginLeft: 75, fontSize: 17 }}>
                                        GoFundMe is trusted around the world for its simple, reliable fundraising platform.</Typography>
                                </CardContent>
                        ...
                        <Grid item sm={4}>
                            ...
                            <Card className={classes.root} elevation={0}>
                                ...
                                <CardContent>
                                    ...
                                    <Typography variant="body2" color="textSecondary" component="p" align="left" style={{ marginLeft: 75, fontSize: 17 }}>
                                    You can personalize and share your GoFundMe in just a few minutes.</Typography>
                                </CardContent>
                    ...
                    <Grid item sm={4}>
                        <Card className={classes.root} elevation={0}>
                            <CardContent>
                                ...
                                <Typography variant="body2" color="textSecondary" component="p" align="left" style={{ marginLeft: 75, fontSize: 17 }}>
                                    The GoFundMe app makes it simple to launch and manage your fundraiser on the go.</Typography>
                            </CardContent>
                        </Card>
                    </Grid>
